...
const sections: LegalSection[] = [
  {
    ...
    body: (
      <>
        <p>
          Invictus (“Invictus”, “we”, “us”, or “our”) is a multi-tenant loan management platform and a
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        use cookies for advertising. You can control cookies through
...
export default function PrivacyPage() {
  return (
    <LegalPage
      eyebrow="Aligned with Law N° 058/2021"
      title="Privacy Policy"
