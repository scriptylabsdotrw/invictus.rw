    ...
    body: (
      <ul>
        <li>
          ...
          ), the operator of the Website and of the Invictus loan management platform.
        </li>
        <li>
          <strong>“Platform”</strong> — the Invictus loan management software, provided to financial
...
export default function TermsPage() {
  return (
    <LegalPage
      eyebrow="Governed by Rwandan law"
      title="Terms & Conditions"
