          ...
          <div key={plan.name} className="flex flex-col items-center gap-1.5">
            {value === true ? (
              ...
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-line/60">
                <span className="text-lg font-light leading-none text-muted/30">
                  —
                </span>
              </span>
            ) : (
        ...
        <Reveal>
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="lead mt-6">
              Every capability, side by side. Start lean and unlock more as your
              institution grows.
            </p>
          </div>
        </Reveal>
            ...
            {plans.map((plan, pi) => {
              ...
              return (
                ...
                >
                  ...
                  <p
                    className={`text-sm font-extrabold ${popular ? "text-white" : "text-ink"}`}
                  >
                    {plan.name}
                  </p>
                  <p
                    className={`mt-0.5 text-[11px] ${popular ? "text-emerald-300" : "text-muted"}`}
                  >
                    {plan.price}
                  </p>
